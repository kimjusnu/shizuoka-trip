export const storyData = [
  ...
  {
    id: "s8",
    title: "KOKO HOTEL 시즈오카 (우리 숙소)",
    subtitle: "시즈오카역 근처 베이스캠프 · 체크인·짐 맡기기",
    structuredContent: [
      { type: "boldText", text: "🏨 KOKO HOTEL 시즈오카" },
      {
        type: "text",
        text: "이번 여행 숙소예요. 시즈오카역 근처라 이동하기 편합니다.",
      },
      { type: "text", text: "" },
      { type: "boldText", text: "🕐 체크인 · 체크아웃" },
      { type: "bullet", text: "체크인: 15:00~" },
      { type: "bullet", text: "체크아웃: ~11:00" },
      { type: "text", text: "" },
      { type: "boldText", text: "🧳 짐 맡기기 (프론트)" },
      {
        type: "bullet",
        text: "짐을 맡기면 번호표(番号札)를 줘요. 모양·안내는 아래 사진 중 2번째를 보면 됩니다.",
      },
      {
        type: "bullet",
        text: "맡길 때·찾을 때 표를 같이 보여주면 수월해요.",
      },
    ],
    images: [
      require("../../assets/koko1.webp"),
      require("../../assets/koko2.png"),
      require("../../assets/koko3.jpg"),
    ],
  },
  {
    id: "s9",
    ...
    structuredContent: [
      ...
      { type: "text", text: "" },
      { type: "boldText", text: "📚 읽어두면 더 재밌는 배경" },
      {
        type: "text",
        text: "사와야카는 '시즈오카에 가면 꼭 한 번은 먹는다'는 말이 붙을 만큼 지역 상징처럼 자리 잡은 체인이라, 첫 식사부터 여행 기분을 확 끌어올리기 좋아요.",
      },
      {
        type: "text",
        text: "반대로 참치 덮밥은 시즈오카가 왜 해산물 도시로 불리는지 바로 체감하게 해 줍니다. 특히 가까운 시미즈항은 참치 이미지가 강한 항구라, 첫날부터 '산'보다 '항구 도시'의 결을 느끼는 선택이기도 해요.",
      },
    ],
    images: [
  ...
  },
  {
    ...
    structuredContent: [
      ...
      { type: "text", text: "" },
      { type: "boldText", text: "📚 읽어두면 좋은 이야기" },
      {
        type: "text",
        text: "나나야는 시즈오카 차를 전면에 내세운 브랜드라 '말차가 진하다'를 넘어, 지역이 가진 차 문화의 자존심을 디저트로 풀어낸 곳에 가깝습니다.",
      },
      {
        type: "text",
        text: "단계별 말차 농도를 고르는 재미 덕분에 여행자들 사이에선 작은 체험처럼 느껴지는데, 특히 No.7은 '도전 메뉴'처럼 회자돼서 첫날 분위기를 올리기에 딱 좋습니다.",
      },
    ],
  ...
  },
  {
    ...
    structuredContent: [
      ...
      {
        type: "text",
        text: "시즈오카는 일본을 대표하는 와사비 산지로 알려져 있어서, 타마루야에 들어가면 단순한 기념품점보다는 '와사비 전문 문화관' 같은 느낌이 납니다.",
      },
      {
        type: "text",
        text: "튜브 와사비나 절임류처럼 일상적으로 쓰기 쉬운 제품이 많은 것도 흥미로운데, 덕분에 여행의 맛을 집까지 가져가기 좋은 쇼핑 포인트가 됩니다.",
      },
    ],
  ...
  },
  {
    ...
    structuredContent: [
      ...
      {
        type: "text",
        text: "미호노 마츠바라는 후지산 세계유산 구성 자산으로 묶일 만큼 상징성이 큰 장소예요. '바다, 소나무, 후지산'이 한 장면에 겹쳐지는 풍경이 일본적 원풍경의 대표 장면처럼 다뤄집니다.",
      },
      {
        type: "text",
        text: "특히 하늘의 선녀가 깃옷을 걸어두었다는 '하고로모 전설'이 남아 있어서, 단순히 예쁜 바다보다도 전설과 풍경이 겹쳐지는 장소라는 점이 이곳의 매력입니다.",
      },
    ],
  ...
  },
  {
    ...
    structuredContent: [
      ...
      {
        type: "text",
        text: "시미즈 쪽이 유독 참치 이미지가 강한 건 항구 도시의 역사와 연결돼 있어요. 그래서 마구로관에서 저녁을 먹는 건 단순한 식사가 아니라 '시미즈다운 밤'을 맛보는 코스에 가깝습니다.",
      },
      {
        type: "text",
        text: "여기에 사쿠라에비까지 곁들이면 시즈오카의 바다를 상징하는 재료를 한 끼에 같이 만나는 셈이라, 첫날 저녁의 기억을 꽤 또렷하게 남겨줍니다.",
      },
    ],
  ...
  },
  {
    ...
    structuredContent: [
      ...
      {
        type: "text",
        text: "시즈오카 오뎅은 국물이 진하게 어두운 색을 띠고, 흑한펜과 가쓰오부시·김가루를 뿌려 먹는 스타일로 유명합니다. 그래서 같은 오뎅이라도 도쿄나 오사카와는 완전히 다른 개성을 느끼게 돼요.",
      },
      {
        type: "text",
        text: "아오바 오뎅거리는 이런 지역 오뎅 문화를 작은 점포들이 이어가는 거리라서, 배를 채우는 것보다 '밤의 로컬 공기'를 체험하는 장소로 생각하면 더 재밌습니다.",
      },
    ],
  ...
  },
  {
    ...
    structuredContent: [
      ...
      {
        type: "text",
        text: "꿈의 대교는 원래부터 관광지를 위해 만든 판타지 공간이라기보다, 일상적인 도로와 계단이 후지산과 절묘하게 겹치며 유명해진 타입의 명소예요.",
      },
      {
        type: "text",
        text: "그래서 현장에 서면 '평범한 도시 인프라가 왜 이렇게 비현실적으로 보이지?' 하는 감각이 오는데, 그 반전이 바로 이곳 사진이 강한 이유입니다.",
      },
    ],
  ...
  },
  {
    ...
    structuredContent: [
      ...
      {
        type: "text",
        text: "후지 혼초의 매력은 관광지처럼 꾸며진 배경이 아니라, 진짜 생활 상점가 뒤로 후지산이 솟아 있다는 데 있어요. 그래서 사진이 더 '일본 여행 같다'기보다 '일본 일상 속 우연한 장면 같다'는 느낌을 줍니다.",
      },
      {
        type: "text",
        text: "간판과 전선, 건널목, 낮은 상가 건물들 사이로 거대한 산이 들어오는 대비가 강해서, 한 장 찍어두면 여행 사진 중에서도 분위기가 가장 독특하게 남는 편입니다.",
      },
    ],
  ...
  },
  {
    ...
    structuredContent: [
      ...
      {
        type: "text",
        text: "후지노미야 야키소바는 쫄깃한 면과 고기기름 찌꺼기, 마무리 생선가루가 특징이라 일본 안에서도 개성이 강한 편이에요. 'B급 구루메'의 대표 주자로 전국적으로 이름을 알린 음식이기도 합니다.",
      },
      {
        type: "text",
        text: "즉 니지야미미에서 먹는 한 접시는 그냥 볶음면이 아니라, 후지노미야라는 도시가 오래 밀어 온 지역 브랜드를 맛보는 경험에 더 가깝습니다.",
      },
    ],
  ...
  },
  {
    ...
    structuredContent: [
      ...
      {
        type: "text",
        text: "타누키 호수는 아사기리 고원의 대표적인 후지산 조망지로, 특정 계절엔 해가 산 정상과 겹치는 '다이아몬드 후지' 명소로도 알려져 있어요.",
      },
      {
        type: "text",
        text: "호수 둘레의 공기가 유난히 잔잔해서, 활기찬 도시 여행 중간에 잠깐 다른 리듬으로 넘어가는 장면처럼 느껴지는 곳입니다.",
      },
    ],
    images: [
  ...
  },
  {
    ...
    structuredContent: [
      ...
      {
        type: "text",
        text: "센겐 신사는 '조용한 신사 산책'이라기보다, 도쿠가와 이에야스와 시즈오카의 관계가 응축된 장소로 보는 편이 더 잘 어울립니다. 그래서 역사 좋아하는 사람에겐 의외로 밀도가 높은 코스예요.",
      },
      {
        type: "text",
        text: "특히 본전 일대의 화려한 채색과 장식은 여행 마지막 날 분위기를 차분하게 가라앉히면서도, 동시에 아주 강한 인상을 남기는 타입의 아름다움입니다.",
      },
    ],
  ...
  },
  {
    ...
    structuredContent: [
      ...
      {
        type: "text",
        text: "슨푸는 도쿠가와 이에야스가 말년을 보낸 도시라서, 공원 산책은 그냥 성터 구경이 아니라 '에도 막부를 연 인물이 마지막으로 도시를 바라보던 자리'를 걷는 감각에 가깝습니다.",
      },
      {
        type: "text",
        text: "그리고 바로 옆 현청 전망대로 올라가면 과거의 성터와 현재의 시가지, 맑은 날의 후지산이 한 프레임에 겹쳐 보여서 시즈오카라는 도시의 층위가 한 번에 정리됩니다.",
      },
    ],
    images: [
  ...
  },
  {
    ...
    structuredContent: [
      ...
      {
        type: "text",
        text: "키르훼봉은 지금은 일본 전국에서 유명하지만 출발점이 시즈오카라는 점 때문에, 본점에 오면 브랜드의 '원점'을 방문하는 기분이 있습니다.",
      },
      {
        type: "text",
        text: "여행 마지막에 이곳을 넣어두면 단순한 디저트 타임보다도, 시즈오카에서 시작된 감각적인 브랜드로 일정을 마무리하는 작은 에필로그처럼 느껴집니다.",
      },
    ],
